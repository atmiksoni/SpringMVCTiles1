...
public class ImmutableObject {
	...
	// class
	private ImmutableObject(Integer fld1, String fld2, Date date) {
	...
	public static ImmutableObject createNewInstance(Integer fld1, String fld2,
			Date date) {
		return new ImmutableObject(fld1, fld2, date);
	}
